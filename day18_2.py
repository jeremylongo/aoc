...
l = 0
t = 0
# at round 519, cycle begins, every 28 rounds.
# Solution is at ((1000000000 - 519) % 28) + 519

finalround = ((1000000000 - 519) % 28) + 519

for minute in range(1, finalround + 1):
    m = update_map(m)
    # print_map(m, minute)
    ...
    print('minute: %s, trees : %s, lumberyards : %s, score: %s' % (minute, t, l, t * l))
